"""
Django settings for dgid_backend project.
...
SECRET_KEY = '&_pd8e8!)uyn7vnj9kxqt%h19ph0#bk*7rym)-c@x1t$_57_q@'
...
if DEBUG is True:
    ...
    ALLOWED_HOSTS = ['.lba.com']
    API_BASE_URL = 'https://api.lba.com'
...
INSTALLED_APPS = [
    ...
    'partenaires.apps.PartenairesConfig',
    'suivis.apps.SuivisConfig',
    'ordres.apps.OrdresConfig',
    'api.apps.ApiConfig',
    'historiques.apps.HistoriquesConfig',
    'users',
]
...
ROOT_URLCONF = 'dgid_backend.urls'
...
WSGI_APPLICATION = 'dgid_backend.wsgi.application'
...
EMAIL_HOST = 'mail.astorprotect.com'
EMAIL_HOST_PASSWORD = 'Mot2p@sse'
EMAIL_HOST_USER = 'vannicknonongo@astorprotect.com'
EMAIL_PORT = 587
